...
void Lagrangian::writeIterData(ofstream &flog, int iter, double zlb, int zub, int zcurr, double alpha, int *lbsol, int *subgrad, double *lambda, double step) {
    int i;
